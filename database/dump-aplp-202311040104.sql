...
INSERT INTO `log_pembayaran` VALUES (1,38,200,'2023-11-02 14:44:13',5,1),(2,38,122000,'2023-11-02 14:44:50',5,1),(3,38,122000,'2023-11-02 17:44:21',5,1),(4,38,122000,'2023-11-02 17:47:48',5,1),(5,38,78000,'2023-11-03 11:14:42',7,1),(6,32,375000,'2023-11-03 21:01:47',8,2),(7,32,375000,'2023-11-03 21:06:39',8,2),(8,32,375000,'2023-11-03 21:14:58',8,2),(9,32,375000,'2023-11-03 21:16:03',8,2),(10,35,176250,'2023-11-04 00:36:02',9,2);
...
INSERT INTO `pelanggan` VALUES (21,'Ramdan','','025180150800','Muhammad Ramdan','Ciaiw',4,0,3),(22,'','','025180150857','Zidun','Bogor',3,47000,3),(23,'','','025180150804','Syamsul Hidayatullah','Bandung',5,0,3),(24,'','','025180151645','Muhammad romi','Sukabirus',8,0,3),(25,'','','027180171426','Fajar Firdaus','Tajur',5,0,3),(26,'','','027180171449','Muhamad Segafi Kurniawan','Cibogo',4,0,3),(27,'','','027180171430','Muhammad Junaedi','Pasir Muncang',8,0,3),(28,'','','027180171444','Muhammad Nur Alfi','Tajur',4,0,3),(29,'','','027180171436','Ramadhan Yoga Pratam','Cengkareng, Jakarta',4,0,3),(30,'','','027180171409','Rizaldy Sukma Perkasa','Ciawi',4,0,3),(31,'','','028180111311','Muhammad ','Ciawi',8,0,3),(32,'muh','$2b$10$HIbhoRtHfl3OmbYlvP8ScOZAFuTT7V9u25KpjntZG4GWdqekRX/dy','1234','muh','sss',1,1255500,3),(33,'','','029180121647','Muhammmad zidun','Ciawi',4,0,3),(34,'','','030180130851','Zainul Fahri','Ciawi',3,0,3),(35,'ari','$2b$10$D.WVK265NkMf1koGl5UgcuklO2LCfH6dinifAqhxKAXYH4pI6cZ2O','030180130856','Ari Aliansyah','Bungur',2,823750,3),(38,'Satrio','$2b$10$5aQORb7vtgq7Bzr6jkwxe.wj1ieFkjSCepZUlL6Q/jz7FYX7JNliK','123','ranbda','sss',1,191000,3),(47,'temen','$2b$10$.VkqB8uuowt78W.5qWxDOuXDEOCs7NNPh5D/0aeMQsWysWMtw4h7.','123','ranbda','sss',1,NULL,3),(48,'','$2b$10$WK07vwGBYWIl2CU.nfsRGeBIwdE82R1ZtWKlePECJKEKLkB2pePtK','123','ranbda','sss',1,NULL,3);
...
INSERT INTO `pembayaran` VALUES (16,7,38,'2023-11-03 11:14:42',NULL,78000,1),(17,8,32,'2023-11-03 21:01:47',NULL,375000,2),(18,8,32,'2023-11-03 21:06:39',NULL,375000,2),(19,8,32,'2023-11-03 21:14:58',NULL,375000,2),(20,8,32,'2023-11-03 21:16:03',NULL,375000,2),(21,9,35,'2023-11-04 00:36:02',NULL,176250,2);
...
INSERT INTO `tagihan` VALUES (7,95,38,11,2023,78,'Lunas',78000),(8,104,32,11,2023,375,'Lunas',375000),(9,98,35,11,2023,235,'Lunas',176250),(10,107,25,11,2023,591,'Belum Lunas',1182000);
...
INSERT INTO `user` VALUES (1,'admin','$2b$10$qy/U6ner.5dwP4nkWXW92.mxuBcHyTVzR6K6EZQQ4j4Hd7fJ/BIBy','admin',1),(2,'petugas','$2b$10$aEbI5I3WcM1/TG.HpztxeObB.uNNnb4dOA87waFdPPgdgAlOMWehy','petugas',2),(3,'joni','$2b$10$sZ6sLqSJ26o8bMhmeF5eNu7dwAB4UkSdYak8boz7v11zueAgY8Y1q','joni',2),(4,'santo','$2b$10$tOiwH3M/3tG.2mWAG4zNpuYrd1ecQVI6HIAFVYC.dv/NcAEEZNhPa','santo',1);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `view_pelanggan_detail`
--

DROP TABLE IF EXISTS `view_pelanggan_detail`;
/*!50001 DROP VIEW IF EXISTS `view_pelanggan_detail`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_pelanggan_detail` AS SELECT 
 1 AS `id_pelanggan`,
 1 AS `username`,
 1 AS `password`,
 1 AS `nama_pelanggan`,
...
--
-- Final view structure for view `view_pelanggan_detail`
--
...
/*!50001 VIEW `view_pelanggan_detail` AS select `pl`.`id_pelanggan` AS `id_pelanggan`,`pl`.`username` AS `username`,`pl`.`password` AS `password`,`pl`.`nama_pelanggan` AS `nama_pelanggan`,`pl`.`nomor_kwh` AS `nomor_kwh`,`pl`.`alamat` AS `alamat`,`pl`.`saldo` AS `saldo`,`t`.`id_tarif` AS `id_tarif`,`t`.`daya` AS `daya`,`t`.`tarifperkwh` AS `tarifperkwh` from (`pelanggan` `pl` join `tarif` `t` on((`t`.`id_tarif` = `pl`.`id_tarif`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`serkom`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `view_user_level` AS select `u`.`id_user` AS `id_user`,`u`.`username` AS `username`,`u`.`nama_admin` AS `nama_admin`,`u`.`id_level` AS `id_level`,`l`.`nama_level` AS `user_level` from (`user` `u` join `level` `l` on((`u`.`id_level` = `l`.`id_level`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-11-04  1:04:54
